                        ...
                        <div class="col-lg-6 col-6 mb-5">
                            <div class="hero-slider-content text-center">
                                ...
                                <div class="slider-btn">
                                    <a href="{{ $slider->link }}" class="secondary-btn">
                                        See Collections
                                        <i class="iocn flaticon-right-arrow"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="section-header-area">
                <div class="row">
                    ...
                    <div class="col-md-6 align-self-end text-md-end">
                        <a href="{{ route('product.index') }}" class="see-btn">See All</a>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row">
                        @foreach ($newarrival as $newarrival )
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="single-grid-product">
                                        <div class="product-top">
                                            <a href="{{ route('product.details',$newarrival->slug) }}"><img class="product-thumbnal"
                    ...
                    <div class="row">
                        @foreach ($bestselling as $bestselling )
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="single-grid-product">
                                        <div class="product-top">
                                            <a href="{{ route('product.details',$bestselling->slug) }}"><img class="product-thumbnal"
                    ...
                    <div class="row">
                        @foreach ($onsale as $onsale )
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="single-grid-product">
                                        <div class="product-top">
                                            <a href="{{ route('product.details',$onsale->slug) }}"><img class="product-thumbnal"
                    ...
                    <div class="row">
                        @foreach ($featured as $featured )
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="single-grid-product">
                                        <div class="product-top">
                                            <a href="{{ route('product.details',$featured->slug) }}"><img class="product-thumbnal"
