                                ...
                                <ul class="product-thumb-silide slider slider-nav">
                                    ...
                                    @foreach ($productImages as $image )
                                        <li class="single-item"><img class="single-item-image"
                                            src="{{ asset('front/assets/images/products/'.$image->img) }}" alt="product" /></li>
                                    @endforeach
                                ...
                                <div class="product-priview-slide slider slider-for">
                                     @foreach ($productImages as $image )
                                        <div class="single-slide">
                                            <img class="slide-image" src="{{ asset('front/assets/images/products/'.$image->img) }}"
                                                alt="product" />
                                        </div>
                                    @endforeach
                            ...
                            <div class="product-right-bottom">
                                <ul class="features">
                                    <li class="single-feature"><img class="icon"
                                            src="{{ asset('front/assets/images/delivery-van-icon.svg') }}" alt="icon" /><strong
                                            class="feature-title">Estimated Delivery:</strong><span
                                            class="feature-text">{{ $product->delivery_duration ?? "" }}</span></li>
                                    {{-- <li class="single-feature"><img class="icon" src="{{ asset('front/assets/images/shipping-return.svg') }}"
                                ...
                                <div class="guarantee-checkout-area">
                                    ...
                                    <img src="{{ asset('front/assets/images/we_accept.webp') }}" alt="payment-method-image" />
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="single-grid-product">
                                <div class="product-top">
                                    <a href="{{ route('product.details',$relProduct->slug) }}"><img class="product-thumbnal"
                                ...
                                <div class="product-info text-center">
                                    <h4 class="product-catagory">{{ $relProduct->brand->en_brand_name }} - {{ $relProduct->category->en_category_name }}</h4>
                                    <input type="hidden" name="quantity" value="1" id="product_quantity">
                                    <h3 class="product-name"><a class="product-link"
                                            href="/product/single/fit-flare-dress-2">{{ $relProduct->en_name  ?? ""}}</a>
                                    </h3>
                                    <!-- This is server side code. User can not modify it. -->
                                    <ul class="product-review">
                                        <li class="review-item"><i class="flaticon-star"></i></li>
